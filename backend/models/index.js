...
db.BoardImage = require("./boardImage.js")(sequelize, Sequelize);
...
db.Member.hasMany(db.Book, { foreignKey: "memberId" });

// Review
db.Review.belongsTo(db.Member); // review:member = N:1
db.Review.hasMany(db.ReviewComment); // review:reviewCmt = 1:N
// Review Comment
db.ReviewComment.belongsTo(db.Review); // reviewCmt:review = N:1

// Wish List
db.WishList.belongsTo(db.Member); // wishList:member = N:1
...
db.Board.hasMany(db.BoardImage, { foreignKey: "boardNo" }); // board:boardImage = 1:N
// boardComments
...
// book
db.Book.belongsTo(db.Member, { foreignKey: "memberId" }); // book:member = N:1
db.Book.hasOne(db.Payment, { foreignKey: "memeberId" });
db.Book.hasOne(db.Payment, { foreignKey: "bookNo" });

// payment 깃새끼!!!!!!!!
db.Payment.belongsTo(db.Book, { foreignKey: "memeberId" }); // payment:book =
db.Payment.belongsTo(db.Book, { foreignKey: "bookNo" }); // payment:book =
